...
class SignupTheme {
  ...
  static TextStyle get fieldHelperStyle => TextStyle(color: AppTheme.textFaint, fontSize: 11.5);
  ...
  static InputDecorationTheme inputDecorationTheme() {
    ...
    return InputDecorationTheme(
      ...
      helperStyle: TextStyle(color: AppTheme.textFaint, fontSize: 11.5),
  ...
  static TextStyle headerTitle({required double fontSize, double letterSpacing = 0}) =>
      TextStyle(color: Colors.white, fontSize: fontSize, fontWeight: FontWeight.bold, letterSpacing: letterSpacing);

  static TextStyle headerSubtitle({required double fontSize}) =>
      TextStyle(color: Colors.white.withOpacity(0.9), fontSize: fontSize, fontWeight: FontWeight.w500);
  ...
  static TextStyle get sectionLabel =>
      TextStyle(color: AppTheme.textFaint, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1.1);

  static TextStyle get dividerLabel =>
      TextStyle(color: AppTheme.textFaint, fontSize: 10.5, fontWeight: FontWeight.w600, letterSpacing: 0.5);
  ...
  static BoxDecoration noticeBoxBg(Color color, {double opacity = 0.12}) =>
      BoxDecoration(color: color.withOpacity(opacity), borderRadius: BorderRadius.circular(12));
